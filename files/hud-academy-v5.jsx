...
function Home({onSelect,stats,onLeaderboard}){
  const cats=[{id:"learn",label:"📚 Study & Learn",color:C.teal},{id:"games",label:"🎮 Mini Games",color:C.purple},{id:"sims",label:"🎯 Simulations",color:C.gold},{id:"exam",label:"📝 Exam Prep",color:C.navy}];
  return(<div style={{minHeight:"100vh",background:`linear-gradient(160deg,${C.navy} 0%,#1E3A5F 55%,#0D6D64 100%)`}}>
    <div style={{textAlign:"center",padding:"36px 24px 20px"}}>
      ...
      <p style={{color:"#94D4CF",fontSize:13,maxWidth:460,margin:"0 auto 20px"}}>21 activities · NHFHC · Kauai · Hilo · Oahu · Maui</p>
